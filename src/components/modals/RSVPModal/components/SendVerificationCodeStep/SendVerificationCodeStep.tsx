  ...
  return (
    <>
      <ModalBody gap={{ base: 4, lg: 5 }} minW="100%" as={Stack}>
        <Flex minW="100%" alignItems={{ base: "center", lg: "start" }} direction={{ base: "column", lg: "row" }} gap={5}>
          <Box
            as="video"
            src={event?.video}
            autoPlay
          ...
          <Stack alignItems={{ base: "center", lg: "start" }} gap={1}>
            ...
            <Text textAlign={{ base: "center", lg: "start" }} maxW="50%" fontSize={"2xs"} fontFamily={"open"} color="whiteAlpha.600">
            ...
            <Text textAlign={{ base: "center", lg: "start" }} lineHeight={"18px"} fontSize="xs" fontFamily={"open"} mt={2} color="whiteAlpha.800">
