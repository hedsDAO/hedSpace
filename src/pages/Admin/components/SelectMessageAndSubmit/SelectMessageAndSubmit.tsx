...
import { Box, Button, Image, Stack, Text, Textarea, useBoolean } from "@chakra-ui/react";
    ...
    <Stack px={{ base: 10, lg: 0 }} minW={{ base: "80%", lg: "30%" }} spacing={4}>
      {!isVerifying ? (
        <>
          ...
          <Textarea color="white" placeholder="Type your message here..." value={message} onChange={(e) => handleInputChange(e)} size="sm" />
